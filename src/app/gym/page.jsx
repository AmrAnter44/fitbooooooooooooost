  ...
  return (
    <div className="min-h-screen bg-black/60 text-white overflow-hidden mt-20">
      ...
      <div className="relative z-10">
        ...
        <a href='https://wa.me/201143564657' className="w-16 h-16 bg-white text-black rounded-full flex items-center justify-center font-bold text-xl hover:bg-white hover:scale-110 transform transition-all duration-300 shadow-lg hover:shadow-xl animate-bounce hover:animate-none cursor-pointer">
